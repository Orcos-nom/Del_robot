...
def generate_launch_description():
    del_description = get_package_share_directory("del_description")

    model_arg = DeclareLaunchArgument(
        name="model",
        default_value=os.path.join(del_description, "urdf", "del.urdf.xacro"),
    ...
    model_path = str(Path(del_description).parent.resolve())
    model_path += pathsep + os.path.join(del_description, "models")
    ...
    gz_spawn_entity = Node(
        ...
        executable="create",
        output="screen",
        arguments=["-topic", "robot_description", "-name", "del", "-allow_renaming", "true"],
    )
